...
{
    public class RotationBehavior: Behavior<UIElement>
    {
        ...
        public static readonly DependencyProperty DegreeToRotateProperty =
            DependencyProperty.Register("DegreeToRotate", typeof(double), typeof(RotationBehavior), new PropertyMetadata(0.0));
